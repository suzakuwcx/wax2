...
const char copyright[] = "dtach - version " "0.9" "(C)Copyright 2004-2016 Ned T. Crigler";

/* argv[0] from the program */
char *progname = "dtach";
/* The name of the passed in socket. */
char *sockname = "/tmp/wax_master.sock";
...
{
	sockname = "/tmp/wax_master.sock";
}

void set_sockname_caves()
{
	sockname = "/tmp/wax_caves.sock";
}
